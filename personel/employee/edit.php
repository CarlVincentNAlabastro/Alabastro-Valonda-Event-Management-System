    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="../../personel/employee/employee.php" class="active">
    ...
    <div class="pagetitle" >
      ...
      <nav>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Persone</li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
             <div style=" display: flex;"> <h5 class="card-title">Employee&nbsp;</h5>
    ...
    <table id="event-table" class="table datatable ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $event['job_title']; ?></td>
