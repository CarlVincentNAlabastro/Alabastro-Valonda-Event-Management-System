...
<li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../../personel/manager/manager.php" class="active">
    ...
    <div class="pagetitle" >
      ...
      <nav>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item "><a href="../manager/manager.php">Data</a></li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
             <div style=" display: flex;"> <h5 class="card-title">Manager&nbsp;</h5>
				
				 <div style = "margin-left:auto; margin-top: auto">
			<a href="../employee/employee.php"><button type="button" class="btn btn-success">Done</button>	 </a>		 
			</div>
    ...
    <table id="event-table" class="table datatable ">
        ...
        <tbody>
            ...
            <tr>
				...
				<td><?php echo $event['postal_code']; ?></td>
