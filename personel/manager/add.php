...
include "../../database/db.php";
 if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO employee( first_name, last_name, job_title, email, mobile_number, address, city, postal_code) VALUES 
 		( '$fn', '$ln', '$jo','$em', '$mn','$ad','$ci','$po')";
            ...
            <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-5">
				...
				<div class="row mb-6">
      			...
      			<div class="col-sm-12">
                    <div class="form-floating mb-3">
                      <input type="text" name= "jo"class="form-control" id="floatingInput" >
                  ...
                  <div class="col-sm-12">
                    <div class="form-floating mb-3">
                      <input type="text" name= "ad"class="form-control" id="floatingInput" >
                  ...
                  <button type="submit" name ="submit" class="btn btn-primary">Submit</button>
                 	<button type="reset" class="btn btn-secondary">RESET</button>
						<a href="../employee - Copy/edit.php"><button type="submit" class="btn btn-secondary">Cancel</button></a>
