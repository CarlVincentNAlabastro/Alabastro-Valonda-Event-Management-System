  ...
  <main>
    ...
    mysqli_close($conn);?>
				...
				<div class="row mb-6">
      			...
      			<div class="col-sm-12">
                    <div class="form-floating mb-3">
                      <input type="text" name= "jo"class="form-control" id="floatingInput"  value="<?php echo $jo ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="form-floating mb-3">
                      <input type="text" name= "ad"class="form-control" id="floatingInput" value="<?php echo $ad ?>">
