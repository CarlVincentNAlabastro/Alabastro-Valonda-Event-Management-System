...
include "../../database/db.php";
 if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO agency( `agency_name`, `address`, `email`, `hotline`) VALUES 
 		( '$name', '$address', '$email', '$hotline','$stat')";
            ...
            <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-5">
                ...
                <div style="width: 500px" class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Add Agency</h5>
                    <p class="text-center small">Enter Agency details </p>
                  </div>
				...
				<div class="row mb-6">
                  ...
                  <div class="col-sm-12">
					...
					<div class="col-sm-12">
                    <div class="form-floating mb-3">
                      <input type="text" name= "hotline"class="form-control" id="floatingInput" >
