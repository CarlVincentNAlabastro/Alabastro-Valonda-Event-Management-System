    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
         <li>
            <a href="../../events/event/event-main.php" class="active">
    ...
    <div class="pagetitle" >
      ...
      <nav>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item "><a href="event-main.php">Data</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
			...
			<a href="event-main.php"><button type="button" class="btn btn-success">Done</button>	 </a>		 
			</div>
...
<div class="table-container">
    <table id="event-table" class="table table-sm">
        <thead>
            <tr>
                <th scope="col">ID</th>
